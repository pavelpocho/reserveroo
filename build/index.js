...
var loader10 = async ({ request, params }) => {
  ...
  console.log("p");
  place == null ? void 0 : place.reservables.forEach((r) => r.reservations.map((re) => console.log(re)));
