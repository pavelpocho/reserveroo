...
var questions = [
  {
    question: "Picture this (keep on scrolling):",
    offset: 1,
    factor: 0.5,
    speed: 0.4
  },
  {
    question: "You are in a foreign city with your friend and want to enjoy your time. What do you do?",
    offset: 1,
    factor: 0.5,
    speed: 0.4
  },
...
var H1 = import_styled_components57.default.h1`
  margin-top: 0rem;
  margin-bottom: 2rem;
  font-size: 8rem;
  ...
  text-align: center;
`;
var H1X = import_styled_components57.default.h1`
  font-size: 6rem;
  width: 80%;
  margin: 2rem auto;
  color: ${styles.colors.primary};
  text-align: center;
`;
var Button3 = import_styled_components57.default.button`
  color: ${styles.colors.white};
  background-color: ${styles.colors.primary};
  border-radius: 0.4rem;
  padding: 0.7rem;
...
`;
var ALink = (0, import_styled_components57.default)(import_react96.Link)`
  text-decoration: none;
`;
var Arrow = (0, import_styled_components57.default)(import_react_fontawesome.FontAwesomeIcon)`
  display: flex;
  margin: 0 auto;
  font-size: 2.5rem;
  color: ${styles.colors.primary};
`;
var FirstQuestionMark = (0, import_styled_components57.default)(import_react_fontawesome.FontAwesomeIcon)`
  right: 5rem;
  margin-top: 3rem;
  font-size: 2.5rem;
  ...
  position: absolute;
`;
var SecondQuestionMark = (0, import_styled_components57.default)(import_react_fontawesome.FontAwesomeIcon)`
  left: 10rem;
  margin-top: 5rem;
  font-size: 2.5rem;
  transform: rotate(-25deg);
  position: absolute;
`;
var ThirdQuestionMark = (0, import_styled_components57.default)(import_react_fontawesome.FontAwesomeIcon)`
  left: 15rem;
  margin-top: 25rem;
  font-size: 2.5rem;
  transform: rotate(25deg);
  position: absolute;
`;
var FourthQuestionMark = (0, import_styled_components57.default)(import_react_fontawesome.FontAwesomeIcon)`
  right: 20rem;
  margin-top: 20rem;
  font-size: 2.5rem;
  transform: rotate(-25deg);
  position: absolute;
`;
var BackgroundStripe = import_styled_components57.default.div`
  width: 100%;
  height: ${(props) => props.height}px;
  background-color: ${styles.colors.primary};
  margin-top: ${(props) => props.space}px;
`;
var BigText = import_styled_components57.default.p`
  font-size: 4rem;
  width: 60%;
  margin: 0 auto;
  text-align: center;
  ...
  margin-top: ${(props) => props.space}px;
`;
var fade = import_styled_components57.keyframes`
  0% { opacity: 0 }
  30% { opacity: 1 }
  60% { opacity: 0 }
  100% { opacity: 0 }
`;
var FaAngleDownA = (0, import_styled_components57.default)(import_fa5.FaAngleDown)`
  animation: ${fade} 1.5s linear 0s infinite;
`;
function About2() {
  const { setLandingPage } = useWhereAreWe();
  const paralaxRef = (0, import_react97.useRef)(null);
  const [yScroll, setYScroll] = (0, import_react97.useState)(0);
  import_react97.default.useEffect(() => {
    ...
    const handleScroll = (ev) => {
      setYScroll(() => {
        var _a, _b;
        return (((_a = paralaxRef.current) == null ? void 0 : _a.current) ?? 0) / (((_b = paralaxRef.current) == null ? void 0 : _b.space) ?? 0);
      });
    };
    if (paralaxRef.current)
      paralaxRef.current.container.current.onscroll = handleScroll;
    return () => {
  ...
  console.log(yScroll);
  return /* @__PURE__ */ import_react97.default.createElement(import_react97.default.Fragment, null, /* @__PURE__ */ import_react97.default.createElement(import_parallax.Parallax, {
    pages: 6.7,
    ref: paralaxRef
  }, /* @__PURE__ */ import_react97.default.createElement(import_parallax.ParallaxLayer, {
    factor: 1,
    speed: 0.1,
    offset: 0.1
  }, /* @__PURE__ */ import_react97.default.createElement("div", null, /* @__PURE__ */ import_react97.default.createElement(H1, null, "What is Reserveroo?"), /* @__PURE__ */ import_react97.default.createElement(IconRow, {
    invertColors: true
  }), /* @__PURE__ */ import_react97.default.createElement(H1X, null, "It's simple.", /* @__PURE__ */ import_react97.default.createElement("br", null), "It's all your favourite activities in one place."), /* @__PURE__ */ import_react97.default.createElement("div", {
    style: { margin: "0 auto", textAlign: "center" }
  }, /* @__PURE__ */ import_react97.default.createElement("p", null, "Scroll down"), /* @__PURE__ */ import_react97.default.createElement("div", null, /* @__PURE__ */ import_react97.default.createElement(FaAngleDownA, {
    ...
    style: { animationDelay: "-1s" },
    className: "fade-arrow"
  })), /* @__PURE__ */ import_react97.default.createElement("div", null, /* @__PURE__ */ import_react97.default.createElement(FaAngleDownA, {
