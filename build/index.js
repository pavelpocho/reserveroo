...
var changeUserPassword = async ({ email, passwordHash }) => await prisma.user.update({
  where: {
    email
  },
  data: {
...
var AccountSummary = ({ editing, user, fieldErrors, fields, formError }) => {
  ...
  }) : /* @__PURE__ */ import_react29.default.createElement(Value, null, user == null ? void 0 : user.phone), editing && !validPhone && /* @__PURE__ */ import_react29.default.createElement(ErrorLabel, null, "Invalid phone"), (fieldErrors == null ? void 0 : fieldErrors.phone) && /* @__PURE__ */ import_react29.default.createElement(FormError, null, fieldErrors.phone)), /* @__PURE__ */ import_react29.default.createElement("div", null, /* @__PURE__ */ import_react29.default.createElement(SectionTitle, null, "Username"), /* @__PURE__ */ import_react29.default.createElement(Value, null, user == null ? void 0 : user.username)), /* @__PURE__ */ import_react29.default.createElement("div", null, /* @__PURE__ */ import_react29.default.createElement(SectionTitle, null, "Reserving since"), /* @__PURE__ */ import_react29.default.createElement(Value, null, new Date(user == null ? void 0 : user.createdAt).toDateString()))))));
};
...
var sendPwdResetEmail = async (sendToAddress, baseUrl, email) => {
  let address = "pavlik.pocho@gmail.com";
  ...
  const msg = {
    ...
    html: `
      ...
      <body>
        ...
        <table style="font-family: 'Roboto', Verdana, Geneva, Tahoma, sans-serif; margin: 30px auto 0px; background-color: #F2F2F8; width: 100%; max-width: 572px; padding: 24px; border-top-left-radius: 8px; border-top-right-radius: 8px">
          <tr>
            <td style="padding-bottom: 16px; text-align: center; font-weight: 700">${status == "confirm_preferred" ? `<p style="width: 200px; font-weight: 400; font-family: 'Roboto', Verdana, Geneva, Tahoma, sans-serif;margin: 0px auto 20px;font-size: 18px;background-color: #74D06C;color: black;border-radius: 6px;padding: 8px;">CONFIRMED</p>` : status == "confirm_backup" ? `<p style="width: 200px; font-weight: 400; font-family: 'Roboto', Verdana, Geneva, Tahoma, sans-serif;margin: 0px auto 20px;font-size: 18px;background-color: #247BA0;color: white;border-radius: 6px;padding: 8px;">BACKUP CONFIRMED</p>` : status == "unavailable" ? `<p style="width: 200px; font-weight: 400; font-family: 'Roboto', Verdana, Geneva, Tahoma, sans-serif;margin: 0px auto 20px;font-size: 18px;background-color: #D7263D;color: white;border-radius: 6px;padding: 8px;">UNAVAILABLE</p>` : ""}${status == "confirm_preferred" ? `Thank you for using Reserveroo! Your time is available and confirmed. Have fun!` : status == "confirm_backup" ? `Your preffered slot was not available, but your backup was free! Have fun!` : status == "unavailable" ? `Unfortunately, your timeslot was not available. Feel free to go for another time though!` : ""}</td>
          </tr>
          <tr>
...
function Login() {
  ...
  return /* @__PURE__ */ import_react33.default.createElement(AuthWrap, null, /* @__PURE__ */ import_react33.default.createElement(import_react32.Form, {
    ...
    hidden: true,
    name: "redirectTo",
    defaultValue: searchParams.get("redirectTo") ?? ((_a = a == null ? void 0 : a.fields) == null ? void 0 : _a.redirectTo) ?? ""
...
var action5 = async ({ request }) => {
  ...
  if (user == null)
    return badRequest({ msg: "Email not found", fields: { email } });
  await sendPwdResetEmail(user == null ? void 0 : user.email, getBaseUrl(request), email);
  return (0, import_server_runtime5.json)({ goodMsg: "Okay! Check your inbox.", fields: { email } });
};
...
function ForgotPassword() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title2, null, "Password Reset - Step 1"), /* @__PURE__ */ React.createElement(IconRow, {
    ...
    style: { paddingBottom: "2rem" }
  }, /* @__PURE__ */ React.createElement(Text2, null, "Enter your email. If you have an account, we will send you a password recovery link."), /* @__PURE__ */ React.createElement(import_react36.Form, {
    method: "post",
    ref
    ...
    name: "email",
    title: "Email",
    defaultValue: ((_a = a == null ? void 0 : a.fields) == null ? void 0 : _a.email) ?? "",
    setValue: () => {
      setDisable(false);
    }
  })), /* @__PURE__ */ React.createElement("div", {
...
var getPlaceWithReservations = async ({ id }) => {
  ...
  p == null ? void 0 : p.reservables.forEach((res) => res.reservations.forEach((r) => console.log(r)));
  return p;
};
...
var ReservableTimes = ({ reservationBackupName, setResList, backup = false, reservationIdName, defaultReservationGroup, reservableIdName, reservables, openingTimes, startName, endName }) => {
  const { lang } = useLangs();
  const [selected, setSelected] = (0, import_react42.useState)(reservables.map((r) => ({ reservableId: r.id, isSelected: !!(defaultReservationGroup == null ? void 0 : defaultReservationGroup.reservations.find((rx) => {
    var _a;
    return rx.backup == backup && ((_a = rx.reservable) == null ? void 0 : _a.id) == r.id;
  })) })));
  const [selectedRange, setSelectedRange] = import_react42.default.useState(defaultReservationGroup && selected.filter((s) => s.isSelected).length > 0 ? getTimeSectionOfReservation(defaultReservationGroup.reservations[0]) : null);
  console.log(selectedRange);
  const [selectedDate, setSelectedDate] = import_react42.default.useState(defaultReservationGroup && selected.filter((s) => s.isSelected).length > 0 ? new Date(defaultReservationGroup.reservations[0].start) : null);
...
var doDaysMatch = (date1, date2, date3) => {
  return new Date(date1).getFullYear() === new Date(typeof date2 == "string" ? date2.slice(0, 16) : date2).getFullYear() && new Date(date1).getFullYear() === new Date(typeof date3 == "string" ? date3.slice(0, 16) : date3).getFullYear() && new Date(date1).getMonth() === new Date(typeof date2 == "string" ? date2.slice(0, 16) : date2).getMonth() && new Date(date1).getMonth() === new Date(typeof date3 == "string" ? date3.slice(0, 16) : date3).getMonth() && new Date(date1).getDate() === new Date(typeof date2 == "string" ? date2.slice(0, 16) : date2).getDate() && new Date(date1).getDate() === new Date(typeof date3 == "string" ? date3.slice(0, 16) : date3).getDate();
};
...
var deleteReservable = ({ id }) => prisma.reservable.delete({
  where: { id }
});

// app/models/reservation.server.ts
var createReservation = async ({ backup, reservationGroupId, reservableId, start, end }) => {
...
var action7 = async ({ request }) => {
  ...
  const getTimeSectionOfReservation2 = (reservation) => {
    return getTimeSectionOfDates2(new Date(reservation.start.slice(0, 16)), new Date(reservation.end.slice(0, 16)));
  };
  ...
  const overlap = !!reservables.map((r, i) => {
    ...
    if (r == null)
      return false;
    return r.reservations.filter((rx) => doDaysMatch(new Date(start), rx.start, rx.end) && doSectionsOverlap2(getTimeSectionOfReservation2(rx), getTimeSectionOfDates2(new Date(start), new Date(end))) && rx.status != 3 /* Cancelled */).length >= r.reservationsPerSlot;
  }).find((o) => o);
  if (overlap) {
    return badRequest4({
      fields: {
...
function PlaceDetails({}) {
  ...
  return place && /* @__PURE__ */ React.createElement(Wrap14, null, /* @__PURE__ */ React.createElement(FlexApart3, {
    style: {
      borderBottom: `1px solid ${styles.colors.gray[50]}`,
      paddingBottom: "2rem",
      marginBottom: "2rem"
    }
  }, /* @__PURE__ */ React.createElement(Title9, null, "Make a reservation"), /* @__PURE__ */ React.createElement(MainButton, {
    inSearch: false,
    to: `/${place.id}/reserve`
...
var ReservationSummary = ({ reservation: r, style }) => {
  ...
  return /* @__PURE__ */ React.createElement(Wrap15, {
    ...
    height: "1rem"
  }), /* @__PURE__ */ React.createElement(Value2, null, getStringTimeValue(new Date(r.start.slice(0, 16))), " - ", getStringTimeValue(new Date(r.end.slice(0, 16)))))));
};
...
var ReservationGroupSummary = ({ reservationGroup: rg, onCancel }) => {
  ...
  const backgroundColor = prefStatus == 0 /* AwaitingConfirmation */ || backupStatus == 0 /* AwaitingConfirmation */ ? styles.colors.warn : prefStatus == 1 /* Confirmed */ && backupStatus == null ? styles.colors.free : prefStatus == 2 /* Rejected */ && backupStatus == null ? styles.colors.busy : prefStatus == 3 /* Cancelled */ && backupStatus == null ? styles.colors.gray[70] : prefStatus == 1 /* Confirmed */ && backupStatus == 3 /* Cancelled */ ? styles.colors.free : prefStatus == 2 /* Rejected */ && backupStatus == 1 /* Confirmed */ ? styles.colors.backup : prefStatus == 2 /* Rejected */ && backupStatus == 2 /* Rejected */ ? styles.colors.busy : prefStatus == 3 /* Cancelled */ && backupStatus == 3 /* Cancelled */ ? styles.colors.gray[70] : "";
  const color = prefStatus == 0 /* AwaitingConfirmation */ || backupStatus == 0 /* AwaitingConfirmation */ ? styles.colors.black : prefStatus == 1 /* Confirmed */ && backupStatus == null ? styles.colors.black : prefStatus == 2 /* Rejected */ && backupStatus == null ? styles.colors.white : prefStatus == 3 /* Cancelled */ && backupStatus == null ? styles.colors.black : prefStatus == 1 /* Confirmed */ && backupStatus == 3 /* Cancelled */ ? styles.colors.black : prefStatus == 2 /* Rejected */ && backupStatus == 1 /* Confirmed */ ? styles.colors.white : prefStatus == 2 /* Rejected */ && backupStatus == 2 /* Rejected */ ? styles.colors.white : prefStatus == 3 /* Cancelled */ && backupStatus == 3 /* Cancelled */ ? styles.colors.black : "";
  ...
  return /* @__PURE__ */ import_react48.default.createElement(import_react48.default.Fragment, null, /* @__PURE__ */ import_react48.default.createElement(ConfirmationDialog, {
    ...
    style: text == "Backup Confirmed" || text == "Cancelled" || text == "Unavailable" ? { opacity: 0.25 } : {}
...
var updateLocation = async ({ id, multiLangCity, multiLangCountry, hidden }) => await prisma.location.update({
  where: {
    id
  },
  data: {
...
var getShownLocations = async () => await prisma.location.findMany({
  where: {
    hidden: false
  },
  include: {
...
var updateTag = async ({ id, multiLangName, multiLangDesc, hidden }) => await prisma.tag.update({
  where: {
    id
  },
  data: {
...
var updateCategory = async ({ id, multiLangName, hidden }) => await prisma.category.update({
  where: {
    id
  },
  data: {
...
var getAllCategories = async () => await prisma.category.findMany({
  include: {
    places: true,
    multiLangName: true
  }
...
var loader17 = async ({ request }) => {
  ...
  const places = await getSearchPlaces({ name: searchTerm ?? "", cityCountry: !location || location == "" ? void 0 : location, tagIds: tags, catIds: categories, itemsPerPage: 10, page: 1 });
...
function Search() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    key: searchTerm + tagIds.join(",") + categoryIds.join(",") + locationCityCountry
  }, /* @__PURE__ */ React.createElement(TopSegment2, null, /* @__PURE__ */ React.createElement(IconRow, null)), /* @__PURE__ */ React.createElement(WidthRestrictor, {
    width: "1368px"
...
var Title14 = import_styled_components39.default.h4`
  
`;
function EditReservation() {
  var _a;
  const { reservationGroup } = (0, import_react63.useLoaderData)();
  const [resList, setResList] = (0, import_react64.useState)([]);
  ...
  const actionData = (0, import_react63.useActionData)();
  const [date, setDate] = import_react64.default.useState(null);
  return (reservationGroup == null ? void 0 : reservationGroup.userId) && place && /* @__PURE__ */ import_react64.default.createElement(import_react63.Form, {
    method: "post"
  }, /* @__PURE__ */ import_react64.default.createElement(Title14, null, "Edit reservation"), /* @__PURE__ */ import_react64.default.createElement(IdInput, {
    name: "userId",
    value: reservationGroup.userId
  }), /* @__PURE__ */ import_react64.default.createElement(IdInput, {
    name: "placeId",
    value: place.id
  }), /* @__PURE__ */ import_react64.default.createElement(IdInput, {
    name: "rgId",
    value: reservationGroup.id
  }), /* @__PURE__ */ import_react64.default.createElement(TextInput, {
    name: "note",
    title: "Note",
    defaultValue: reservationGroup.note
  }), (place == null ? void 0 : place.reservables) && /* @__PURE__ */ import_react64.default.createElement(ReservableTimes, {
    reservationBackupName: "reservationBackup[]",
    reservables: place.reservables,
    openingTimes: place.openingTimes.sort((a, b) => a.day - b.day),
    startName: "start[]",
    ...
    reservationIdName: "reservationId[]",
    setResList
  }), /* @__PURE__ */ import_react64.default.createElement("p", null, "Backup timeslots (if any):"), (place == null ? void 0 : place.reservables) && /* @__PURE__ */ import_react64.default.createElement(ReservableTimes, {
    reservationBackupName: "reservationBackup[]",
    backup: true,
    reservables: place.reservables,
    openingTimes: place.openingTimes.sort((a, b) => a.day - b.day),
    ...
    reservationIdName: "reservationId[]",
    setResList
  }), (actionData == null ? void 0 : actionData.formError) && /* @__PURE__ */ import_react64.default.createElement("p", null, actionData.formError ?? ""), /* @__PURE__ */ import_react64.default.createElement("input", {
    type: "submit"
  }));
}
...
var Wrap19 = import_styled_components40.default.div`
  ...
  gap: 2rem;
`;
var Title15 = import_styled_components40.default.p`
  font-weight: bold;
  font-size: 0.9rem;
  margin: 0;
  margin-top: 1rem;
  color: ${styles.colors.action};
`;
var Value4 = import_styled_components40.default.p`
  font-size: 1.2rem;
  margin-top: 0.2rem;
  margin-bottom: 0;
`;
var AdminReservationSummary = ({ reservation: r }) => {
  var _a, _b;
  return /* @__PURE__ */ React.createElement(Wrap19, null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title15, null, "Place"), /* @__PURE__ */ React.createElement(Value4, null, (_a = r.reservable) == null ? void 0 : _a.place.name)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title15, null, "Facility"), /* @__PURE__ */ React.createElement(Value4, null, (_b = r.reservable) == null ? void 0 : _b.name)), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title15, null, "Start"), /* @__PURE__ */ React.createElement(Value4, null, new Date(r.start.slice(0, 16)).toLocaleDateString(), " - ", getStringTimeValue(new Date(r.start.slice(0, 16))))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title15, null, "End"), /* @__PURE__ */ React.createElement(Value4, null, new Date(r.end.slice(0, 16)).toLocaleDateString(), " - ", getStringTimeValue(new Date(r.end.slice(0, 16))))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title15, null, "Status"), /* @__PURE__ */ React.createElement(Value4, null, r.status == 0 /* AwaitingConfirmation */ ? "Awaiting confirmation" : r.status == 1 /* Confirmed */ ? "Confirmed" : r.status == 2 /* Rejected */ ? "Rejected" : r.status == 3 /* Cancelled */ ? "Cancelled" : r.status == 4 /* Paid */ ? "Paid" : r.status == 6 /* Past */ ? "Past" : "")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title15, null, "Previous Status"), /* @__PURE__ */ React.createElement(Value4, null, r.previousStatus == 0 /* AwaitingConfirmation */ ? "Awaiting confirmation" : r.previousStatus == 1 /* Confirmed */ ? "Confirmed" : r.previousStatus == 2 /* Rejected */ ? "Rejected" : r.previousStatus == 3 /* Cancelled */ ? "Cancelled" : r.previousStatus == 4 /* Paid */ ? "Paid" : r.previousStatus == 6 /* Past */ ? "Past" : "")), r.backup && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Title15, null, "Backup"), /* @__PURE__ */ React.createElement(Value4, null, "This slot is a backup.")));
};

// app/components/admin/reservation-group-summary.tsx
var Title16 = import_styled_components41.default.h5`
  margin: 0;
  font-size: 1.2rem;
`;
var InfoTitle = import_styled_components41.default.p`
  font-weight: bold;
  font-size: 0.9rem;
  margin: 0;
  margin-top: 1.5rem;
  color: ${styles.colors.action};
`;
var Value5 = import_styled_components41.default.p`
  font-size: 1.2rem;
  margin-top: 0.2rem;
  margin-bottom: 0;
`;
var SummaryInfoWrap = import_styled_components41.default.div`
  display: flex;
  gap: 2rem;
`;
...
`;
var UpdateStatus = import_styled_components41.default.button`
  display: block;
  margin: 1rem 0rem;
`;
var InnerWrap4 = import_styled_components41.default.div`
`;
var AdminReservationGroupSummary = ({ reservationGroup: rg }) => {
  ...
  return /* @__PURE__ */ import_react66.default.createElement(import_react66.default.Fragment, null, /* @__PURE__ */ import_react66.default.createElement(Wrap20, {
    key: rg.id,
    ref
  }, /* @__PURE__ */ import_react66.default.createElement(InnerWrap4, null, /* @__PURE__ */ import_react66.default.createElement(Title16, null, (_a = rg.user) == null ? void 0 : _a.username), rg.reservations.map((r) => /* @__PURE__ */ import_react66.default.createElement("div", {
    key: r.id
  }, /* @__PURE__ */ import_react66.default.createElement(AdminReservationSummary, {
    reservation: r
  }))), /* @__PURE__ */ import_react66.default.createElement(SummaryInfoWrap, null, /* @__PURE__ */ import_react66.default.createElement("div", null, /* @__PURE__ */ import_react66.default.createElement(InfoTitle, null, "Created"), /* @__PURE__ */ import_react66.default.createElement(Value5, null, new Date(rg.createdAt).toDateString(), ", ", new Date(rg.createdAt).toTimeString())), /* @__PURE__ */ import_react66.default.createElement("div", null, /* @__PURE__ */ import_react66.default.createElement(InfoTitle, null, "Note to business"), /* @__PURE__ */ import_react66.default.createElement(Value5, null, rg.note))), rg.reservations.length > 0 && !rg.reservations.find((r) => r.status == 3 /* Cancelled */ || r.status == 1 /* Confirmed */ || r.status == 2 /* Rejected */) && /* @__PURE__ */ import_react66.default.createElement(import_react65.Form, {
    method: "post",
    action: "/admin/reservations?index"
  }, /* @__PURE__ */ import_react66.default.createElement(SingleSelectorInput, {
    name: "action",
    possibleValuesAndTexts: actions,
    defaultValueAndText: null
  }), /* @__PURE__ */ import_react66.default.createElement(IdInput, {
    name: "rgId",
    value: rg.id
  }), /* @__PURE__ */ import_react66.default.createElement("p", null, 'Select a status in the input above and then hit "Update status". This WILL SEND AN EMAIL to the user!'), /* @__PURE__ */ import_react66.default.createElement(UpdateStatus, null, "Update status")), /* @__PURE__ */ import_react66.default.createElement(import_react65.Form, {
    method: "post",
    ...
    name: "rgId",
    value: rg.id
  }), /* @__PURE__ */ import_react66.default.createElement("p", null, "Select an attendance if we for example know a person didn't show up..."), /* @__PURE__ */ import_react66.default.createElement(UpdateStatus, null, "Update attendance")), /* @__PURE__ */ import_react66.default.createElement(import_react65.Link, {
...
var Title17 = import_styled_components42.default.h4`
  
`;
function ReservationAdminList() {
  const { reservationGroups } = (0, import_react67.useLoaderData)();
  const [showPast, setShowPast] = (0, import_react68.useState)(false);
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Title17, null, "Reservations"), /* @__PURE__ */ React.createElement("button", {
    ...
    if (rg.reservations.length > 0 && new Date(rg.reservations[0].end.slice(0, 16)).getTime() < new Date().getTime() && showPast || rg.reservations.length > 0 && new Date(rg.reservations[0].end.slice(0, 16)).getTime() > new Date().getTime() && !showPast) {
...
var ArrayInputWrap2 = import_styled_components43.default.div`
  display: flex;
`;
function AdminCategoryDetail() {
  ...
  }), /* @__PURE__ */ React.createElement(SingleSelectorInput, {
    name: "hidden",
    possibleValuesAndTexts: [{ value: "1", text: "Hidden" }, { value: "0", text: "Visible" }],
    defaultValueAndText: { value: (category == null ? void 0 : category.hidden) ? "1" : "0", text: (category == null ? void 0 : category.hidden) ? "Hidden" : "Visible" }
  }), /* @__PURE__ */ React.createElement("input", {
    type: "submit"
  })));
}
...
var ArrayInputWrap3 = import_styled_components44.default.div`
  display: flex;
`;
...
var ArrayInputWrap4 = import_styled_components45.default.div`
  display: flex;
`;
...
var ArrayInputWrap5 = import_styled_components46.default.div`
  display: flex;
`;
...
var ArrayInputWrap6 = import_styled_components47.default.div`
  display: flex;
`;
function AdminLocationDetail() {
  ...
  return location && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", null, "LOCATION: ", (location == null ? void 0 : location.multiLangCity) && (location == null ? void 0 : location.multiLangCity[lang]), " in ", (location == null ? void 0 : location.multiLangCountry) && (location == null ? void 0 : location.multiLangCountry[lang])), /* @__PURE__ */ React.createElement(import_react79.Form, {
    ...
    name: "hidden",
    possibleValuesAndTexts: [{ value: "1", text: "Hidden" }, { value: "0", text: "Visible" }],
    defaultValueAndText: { value: (location == null ? void 0 : location.hidden) ? "1" : "0", text: (location == null ? void 0 : location.hidden) ? "Hidden" : "Visible" }
  }), /* @__PURE__ */ React.createElement("input", {
    type: "submit"
  })));
}
...
var ArrayInputWrap7 = import_styled_components48.default.div`
  display: flex;
`;
...
var ButtonWrap2 = import_styled_components49.default.button`

`;
var Button = ({ children, onClick }) => /* @__PURE__ */ React.createElement(ButtonWrap2, {
  onClick: (e) => {
    e.preventDefault();
    onClick(e);
  }
...
var NumberInputField = import_styled_components50.default.input`
  font-size: 0.8rem;
  line-height: 2rem;
  padding: 0rem 1rem;
...
var TimeInputField = import_styled_components51.default.input`
  font-size: 0.8rem;
  line-height: 2rem;
  padding: 0rem 1rem;
  border: 1.5px solid ${styles.colors.gray[30]};
...
var ArrayInputWrap8 = import_styled_components52.default.div`
  display: flex;
`;
function AdminPlaceDetail() {
  ...
  }), /* @__PURE__ */ import_react88.default.createElement("div", null, /* @__PURE__ */ import_react88.default.createElement("p", null, "DO NOT CHANGE RESERVATIONS PER SLOT TO ANYTHING OTHER THAN 1"), /* @__PURE__ */ import_react88.default.createElement(NumberInput, {
...
var ArrayInputWrap9 = import_styled_components53.default.div`
  display: flex;
`;
...
function CompaniesAdmin3() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", null, "USER (ATTENDANCE) ADMIN"), /* @__PURE__ */ React.createElement(import_react92.Outlet, null));
}
...
var Wrap21 = import_styled_components54.default.div`
  display: flex;
  gap: 2rem;
`;
var Title18 = import_styled_components54.default.p`
  font-weight: bold;
  font-size: 0.9rem;
  margin: 0;
  margin-top: 1rem;
  color: ${styles.colors.action};
`;
var Value6 = import_styled_components54.default.p`
  font-size: 1.2rem;
  margin-top: 0.2rem;
  margin-bottom: 0;
`;
var Card = import_styled_components54.default.div`
  margin: 0.2rem;
  width: 100%;
  padding: 1rem;
`;
...
var Title19 = import_styled_components55.default.h4`
  
`;
function ReservationAdminList2() {
  const { users } = (0, import_react93.useLoaderData)();
...
function AdminTagDetail() {
  ...
  return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", null, "TAG: ", (_a = tag.multiLangName) == null ? void 0 : _a.czech), /* @__PURE__ */ React.createElement(import_react95.Form, {
    ...
    defaultValue: (_e = tag == null ? void 0 : tag.multiLangDesc) == null ? void 0 : _e.english
  }), /* @__PURE__ */ React.createElement(SingleSelectorInput, {
    name: "hidden",
    possibleValuesAndTexts: [{ value: "1", text: "Hidden" }, { value: "0", text: "Visible" }],
    defaultValueAndText: { value: (tag == null ? void 0 : tag.hidden) ? "1" : "0", text: (tag == null ? void 0 : tag.hidden) ? "Hidden" : "Visible" }
  }), /* @__PURE__ */ React.createElement("input", {
    type: "submit"
  })));
}
...
var ScrollEffectWrap = import_styled_components58.default.div`
  position: fixed;
  top: 85x;
  ...
  width: 100vw;
`;
var ScrollEffectInner = import_styled_components58.default.div`
...
var book_default = "/build/_assets/book-XAH5KXM2.png";

// app/assets/images/search.png
var search_default = "/build/_assets/search-E2EQ74QL.png";

// app/assets/images/details.png
var details_default = "/build/_assets/details-4LDV2CNE.png";
...
var H1 = import_styled_components59.default.h1`
  ...
  text-align: center;
`;
var H1X = import_styled_components59.default.h1`
  ...
  text-align: center;
`;
var fade = import_styled_components59.keyframes`
  0% { opacity: 0 }
  30% { opacity: 1 }
  60% { opacity: 0 }
  100% { opacity: 0 }
`;
var FaAngleDownA = (0, import_styled_components59.default)(import_fa6.FaAngleDown)`
  animation: ${fade} 1.5s linear 0s infinite;
`;
var ScrollItem = (0, import_styled_components59.default)(import_react_spring.animated.div).attrs((props) => {
  const sp = props.transform.split(",")[1].split("px")[0];
  if (sp < (props.extendPresence ? 2e3 : 1e3) && sp > (props.extendPresence ? -1200 : -600)) {
    return {
      style: {
  ...
  height: 100%;
`;
var Sphere = (0, import_styled_components59.default)(ScrollItem)`
  height: 200px;
  width: 200px;
  border-radius: 100px;
  position: absolute;
  ...
  background-color: ${styles.colors.primary};
`;
var AboutHeader = import_styled_components59.default.div`
  background-color: ${styles.colors.primary};
  width: 100%;
  padding-bottom: 4rem;
`;
var AboutSubHeader = import_styled_components59.default.div`
  height: 30vh;
  width: 100%;
  box-shadow: 0px -2px 24px -12px #33333399;
  background-color: ${styles.colors.gray[20]};
`;
var AboutSubSubHeader = import_styled_components59.default.div`
  height: 80%;
  width: 100%;
  top: 0;
  position: absolute;
  background-color: ${styles.colors.white};
`;
var PurpleSection = import_styled_components59.default.div`
  height: 55vh;
  width: 100%;
  top: 0;
  position: absolute;
  background-color: ${styles.colors.primary};
`;
var ScrollDownIndicator = ({ screenHeight }) => /* @__PURE__ */ import_react98.default.createElement("div", {
  style: { width: "100%", marginTop: "5vh" }
}, /* @__PURE__ */ import_react98.default.createElement(H1X, null, "Scroll down to find out!"), /* @__PURE__ */ import_react98.default.createElement("div", {
  style: { textAlign: "center", marginTop: "2vh" }
}, /* @__PURE__ */ import_react98.default.createElement(FaAngleDownA, {
  size: 24 / 1080 * screenHeight,
  color: styles.colors.white,
...
var Card2 = import_styled_components59.default.div`
  padding: 1.2vh 24px;
  border-radius: 12px;
  max-width: 576px;
...
`;
var HowItWorksLineWrap = import_styled_components59.default.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  padding: 2rem 0;
...
`;
var HowDoesItWorkItem = (props) => /* @__PURE__ */ import_react98.default.createElement(HowItWorksLineWrap, {
  style: props.back ? {
    background: "linear-gradient(to right, #f1f1f100, #f1f1f1ff, #f1f1f100)"
  } : {}
}, /* @__PURE__ */ import_react98.default.createElement("h4", {
  style: { fontSize: "max(min(1.5vh, 3vw), 1rem)", textAlign: props.screenWidth > 600 ? "unset" : "center", padding: "1.5rem" }
}, props.title), /* @__PURE__ */ import_react98.default.createElement("img", {
  style: { boxShadow: styles.shadows[0] },
  width: props.screenWidth > 600 ? 560 : props.screenWidth * 0.85,
  src: props.imgSrc,
  alt: ""
}));
var HowItWorksWrap = import_styled_components59.default.div`
  max-width: 968px;
  margin: 0 auto;
  @media (max-width: 1004px) {
    margin-top: 10rem;
...
`;
var HowItWorksTitle = import_styled_components59.default.h3`
  font-size: 1.6rem;
  @media (max-width: 1004px) {
    text-align: center;
  }
`;
var QuestionTitle = import_styled_components59.default.p`
  text-align: center;
  font-weight: bold;
  ...
  color: ${styles.colors.primary};
`;
var SecondScrollItemContainer = import_styled_components59.default.div`
  display: flex;
  max-width: 936px;
  margin: 5vh auto;
  position: relative;
...
`;
var ContactUs = import_styled_components59.default.a`
  background-color: ${styles.colors.action};
  color: ${styles.colors.black};
  ...
  text-decoration: none;
`;
var QuestionInsideCard = import_styled_components59.default.p`
  font-size: max(min(1.5vh, 2.5vw), 0.8rem);
  font-weight: 400;
  margin-top: 0.5rem;
  color: ${styles.colors.white};
`;
var TitleInsideCard = import_styled_components59.default.p`
  font-weight: bold;
...
var QuestionCard = ({ title, children, white }) => {
  return /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { margin: "14vh auto", maxWidth: "938px", zIndex: 2, position: "relative", display: "flex" }
  }, /* @__PURE__ */ import_react98.default.createElement(Card2, null, /* @__PURE__ */ import_react98.default.createElement("p", {
    style: { fontWeight: "bold", fontSize: "max(min(4vh, 6vw), 1.5rem)", marginBottom: "1vh", color: white ? styles.colors.white : styles.colors.primary }
  }, title), /* @__PURE__ */ import_react98.default.createElement("p", {
    style: { fontSize: "max(min(2vh, 3vw), 1rem)", fontWeight: "400", marginTop: "1vh", color: white ? styles.colors.white : styles.colors.black }
  }, children)));
};
function About2() {
  const { setLandingPage } = useWhereAreWe();
  const scrollEffectWrap = (0, import_react98.useRef)(null);
  const requestRef = (0, import_react98.useRef)(null);
  const [screenHeight, setScreenHeight] = (0, import_react98.useState)(-1);
  const [screenWidth, setScreenWidth] = (0, import_react98.useState)(-1);
  const [yScrollPixels, setYScrollPixels] = (0, import_react98.useState)(0);
  const howItWorksRef = (0, import_react98.useRef)(null);
  const gSHP = (fraction, sh) => sh * fraction + 90;
  const headerEffect = {
    startValue: 85,
    slope: -0.5
  };
  ...
  console.log(screenHeight);
  const subHeaderEasing = (0, import_react98.useMemo)(() => getEasingFunctionXandZ({
  ...
  const subSubHeaderEasing = (0, import_react98.useMemo)(() => getEasingFunctionXandZ({
  ...
  const subSubHeaderBlobEasing = (0, import_react98.useMemo)(() => getEasingFunctionXandZ({
  ...
  const subSubHeaderIconsEasing = (0, import_react98.useMemo)(() => getEasingFunctionXandZ({
    start: { value: gSHP(0.96, screenHeight), slope: -1.9 },
    stand: { scroll: gSHP(0.5, screenHeight), value: gSHP(0.2, screenHeight) },
    end: { scroll: gSHP(0.82, screenHeight), slope: -2.1 }
  }), [screenHeight]);
  const purpleSectionIconEasings = (0, import_react98.useMemo)(() => [...Array(10).keys()].map((i) => ({
    startValue: gSHP(1.4 + (Math.random() - 0.5) * 0.02, screenHeight),
    slope: -1.2 + (Math.random() - 0.5) * 0.3
  })), [screenHeight]);
  const explanationSection = (0, import_react98.useMemo)(() => getEasingFunctionXandZ({
  ...
  const randomPositions = (0, import_react98.useMemo)(() => [
    [0, 0, 20]
  ].concat([...Array(9).keys()].map((i) => [Math.random() * 300, Math.random() * 200 + 10, Math.random() * 60 + 30, (Math.random() - 0.5) * 2])), []);
  const howItWorks = {
    startValue: gSHP(2.5, screenHeight),
    slope: -1
  };
  console.log("heihgt");
  console.log(noEase(0, howItWorks));
  function getSpaceByScreenWidth(screenHeight2, screenWidth2) {
    if (screenWidth2 > 1005) {
      return 4 + (screenHeight2 < 900 ? 0.5 : 0);
    }
    if (screenWidth2 < 420) {
      return 5.4 + (screenHeight2 < 900 ? 0.5 : 0);
    }
    return 4.6 + (screenHeight2 < 900 ? 0.5 : 0);
  }
  return /* @__PURE__ */ import_react98.default.createElement(import_react98.default.Fragment, null, /* @__PURE__ */ import_react98.default.createElement(ScrollEffectWrap, {
    style: screenHeight == -1 ? { opacity: 0 } : { opacity: 1 },
    ref: scrollEffectWrap
  }, /* @__PURE__ */ import_react98.default.createElement(ScrollEffectInner, {
    space: (noEase(0, howItWorks) + (screenWidth < 1005 ? 2e3 : 1400)) / screenHeight
  }), /* @__PURE__ */ import_react98.default.createElement(ScrollItem, {
    transform: `translate(0px, ${noEase(yScrollPixels, headerEffect)}px)`
  }, /* @__PURE__ */ import_react98.default.createElement(AboutHeader, null, /* @__PURE__ */ import_react98.default.createElement(H1, null, "What is Reserveroo?"), /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { transform: `scale(${screenHeight / 1080 * 1.5}` }
  }, /* @__PURE__ */ import_react98.default.createElement(IconRow, null)), /* @__PURE__ */ import_react98.default.createElement(ScrollDownIndicator, {
    screenHeight
  }))), /* @__PURE__ */ import_react98.default.createElement(ScrollItem, {
    transform: `translate(0px, ${easeInOut(yScrollPixels, subHeaderEasing)}px)`
  }, /* @__PURE__ */ import_react98.default.createElement(AboutSubHeader, null)), /* @__PURE__ */ import_react98.default.createElement(ScrollItem, {
    transform: `translate(0px, ${easeInOut(yScrollPixels, subSubHeaderEasing)}px)`
  }, /* @__PURE__ */ import_react98.default.createElement(QuestionCard, {
    white: false,
    title: questions[0].title
  }, questions[0].question), /* @__PURE__ */ import_react98.default.createElement(AboutSubSubHeader, null)), /* @__PURE__ */ import_react98.default.createElement(ScrollItem, {
    onlyDesktop: true,
    transform: `translate(0px, ${easeInOut(yScrollPixels, subSubHeaderBlobEasing) + (screenWidth < 936 ? 200 : 0)}px)`
  }, /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { position: "relative", maxWidth: "936px", margin: "12rem auto" }
  }, /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { position: "absolute", right: screenWidth < 936 ? "25%" : "0", top: "0", width: "322px" }
    ...
    onlyDesktop: true,
    transform: `translate(0px, ${easeInOut(yScrollPixels, subSubHeaderIconsEasing) + (screenWidth < 936 ? 200 : 0)}px)`
  }, /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { position: "relative", maxWidth: "936px", margin: "12rem auto" }
  }, /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { position: "absolute", right: screenWidth < 936 ? "25%" : "0", top: "0", width: "322px" }
  }, /* @__PURE__ */ import_react98.default.createElement(import_fa6.FaVolleyballBall, {
    color: styles.colors.white,
    size: 54,
    style: { position: "absolute", top: "35px", left: "40px" }
  }), /* @__PURE__ */ import_react98.default.createElement(import_fa6.FaTableTennis, {
    color: styles.colors.white,
    size: 54,
    style: { position: "absolute", top: "95px", left: "110px" }
  }), /* @__PURE__ */ import_react98.default.createElement(import_fa6.FaGolfBall, {
    color: styles.colors.white,
    size: 54,
    style: { position: "absolute", top: "155px", left: "180px" }
  }), /* @__PURE__ */ import_react98.default.createElement(import_fa6.FaSwimmer, {
    color: styles.colors.white,
    size: 54,
    style: { position: "absolute", top: "165px", left: "65px" }
  }), /* @__PURE__ */ import_react98.default.createElement(import_fa6.FaBowlingBall, {
    color: styles.colors.white,
    size: 54,
  ...
  }, /* @__PURE__ */ import_react98.default.createElement(QuestionTitle, null, questions[4].title), /* @__PURE__ */ import_react98.default.createElement(QuestionTitle, null, questions[5].title), /* @__PURE__ */ import_react98.default.createElement(QuestionTitle, null, questions[6].title), /* @__PURE__ */ import_react98.default.createElement(QuestionTitle, null, questions[7].title)), /* @__PURE__ */ import_react98.default.createElement(IconRow, {
    invertColors: true
  })), /* @__PURE__ */ import_react98.default.createElement(ScrollItem, {
    extendPresence: true,
    transform: `translate(0px, ${noEase(yScrollPixels, purpleSectionEffect)}px)`
  }, /* @__PURE__ */ import_react98.default.createElement(SecondScrollItemContainer, null, /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { flexShrink: "1", maxWidth: "786px" }
  }, /* @__PURE__ */ import_react98.default.createElement(Card2, null, /* @__PURE__ */ import_react98.default.createElement(TitleInsideCard, null, questions[1].title), /* @__PURE__ */ import_react98.default.createElement(QuestionInsideCard, null, questions[1].question)), /* @__PURE__ */ import_react98.default.createElement(Card2, null, /* @__PURE__ */ import_react98.default.createElement(TitleInsideCard, null, questions[2].title), /* @__PURE__ */ import_react98.default.createElement(QuestionInsideCard, null, questions[2].question)), /* @__PURE__ */ import_react98.default.createElement(Card2, null, /* @__PURE__ */ import_react98.default.createElement(TitleInsideCard, null, questions[3].title), /* @__PURE__ */ import_react98.default.createElement(QuestionInsideCard, null, questions[3].question)))), /* @__PURE__ */ import_react98.default.createElement(PurpleSection, null)), [...Array(10).keys()].map((i) => /* @__PURE__ */ import_react98.default.createElement(ScrollItem, {
    onlyDesktop: true,
    key: i,
    transform: `translate(0px, ${noEase(yScrollPixels, purpleSectionIconEasings[i])}px)`
  }, /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { position: "relative", maxWidth: "936px", margin: "12rem auto" }
  }, /* @__PURE__ */ import_react98.default.createElement("div", {
    style: { position: "absolute", right: "0", top: "0", width: "322px" }
  }, /* @__PURE__ */ import_react98.default.createElement(import_fa6.FaQuestionCircle, {
    ...
    ref: howItWorksRef,
    extendPresence: true,
    transform: `translate(0px, ${noEase(yScrollPixels, howItWorks)}px)`
  }, /* @__PURE__ */ import_react98.default.createElement(HowItWorksWrap, null, /* @__PURE__ */ import_react98.default.createElement(HowItWorksTitle, null, "How does it work?"), /* @__PURE__ */ import_react98.default.createElement(HowDoesItWorkItem, {
    screenWidth,
    back: false,
    title: "1. Find your favourite activity",
    imgSrc: search_default
  }), /* @__PURE__ */ import_react98.default.createElement(HowDoesItWorkItem, {
    screenWidth,
    back: true,
    title: "2. Check out all the details",
    imgSrc: details_default
  }), /* @__PURE__ */ import_react98.default.createElement(HowDoesItWorkItem, {
    screenWidth,
    back: false,
  ...
  }), /* @__PURE__ */ import_react98.default.createElement("h2", {
    style: { maxWidth: "968px", margin: "0 auto", padding: "0 1.5rem", textAlign: "center" }
  }, "Would you like to list your place on Reserveroo?"), /* @__PURE__ */ import_react98.default.createElement("p", {
    style: {
      fontSize: "1rem",
      fontWeight: "bold",
      textAlign: "center",
